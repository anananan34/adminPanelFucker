...
playsound("keskin.mp3",False)
#MessageBox = ctypes.windll.user32.MessageBoxW

print(Fore.GREEN +"""
                                         
        +----------------------------------+
        | Ellie Williams - t.me/theXsploit |
        +----------------------------------+
        | Check @theXsploit on Telegram    |
        +----------------------------------+

      """)
print("")
#MessageBox(None, 'Ellie', 'Ellie', 0)
print(Fore.WHITE +" [?] Set Target  ")



site = input(Back.LIGHTWHITE_EX+Fore.BLACK+"  root@ellie:~# "+Back.BLACK+Fore.GREEN)
print(Style.RESET_ALL)
print(Fore.GREEN +"""

  if you want clean print press enter...

""")
print(Style.RESET_ALL)
e = input(Back.LIGHTWHITE_EX+Fore.BLACK +"  root@ellie:~# ")
print(Style.RESET_ALL)
a = -1
wr = open("ellie.txt","a")
if e == 'S':
  while True:
      ...
      for god in panel:
        stdout.write("")
      print(Fore.BLUE+Back.WHITE+"   [?] Forcing  "+Back.YELLOW+panel[a],end='\r')
      s = "{}".format(panel[a])
      try :
          ...
          cont = conta.find("404")       
          if cont == -1:
            print(Fore.GREEN +"[!] HIT  "+url+" Status " +stat+"\n")
            wr.write("{}\n".format(url))
      except Exception:
        print(Fore.RED +"[!] MISSING HIT ")
else:
  while True:
    a += 1
    s = "{}".format(panel[a])
    ...
    try :
        ...
        if cont == -1:
          uz = int(len(url))
          print(uz * "-")
          print("\n"+Fore.GREEN +"[+] HIT  "+url+" Status " +stat+"\n")
          print(uz * "-")
          wr.write("{}\n".format(url))
    except Exception:
       asdhjbasdbasd = 0
#coded by ellie https://www.github.com/arda6